<%-- 
    Document   : solicitudespropias
    Created on : 20-06-2019, 0:29:30
    Author     : Silvana
--%>
...
<%
    ...
    if (session.getAttribute("nombreusuario") == null) {
        ...
        soli = daosoli.consultarSolicitudesUsuCrea( (String) session.getAttribute("usuario") );
...
<html>
    ...
    <head>
        ...
        <title>Solicitudes Propias - Gestión Documental</title>        <!-- Tell the browser to be responsive to screen width -->
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Solicitudes Propias
                        <small>Aqui encontrara toda las Solicitudes que usted ha realizado</small>
                    </h1>
                                    ...
                                    <tbody>
                                        <%
                                            for (Solicitud s : soli) {
                                                ...
                                                out.print("<tr id='row" + "' value='" + s.getIdSolicitud() + "' style='cursor: pointer;'>"
                                                        + "<td name='idSol' class='mailbox-number'>" + s.getIdSolicitud() + "</td>"
                                                        + "<td class='mailbox-name'><a href=Solicitud.jsp?tiposol=propia&idsolicitud=" + s.getIdSolicitud() + ">" + userSend.getNombre() + "</a></td>"
                                                        + "<td class='mailbox-name'>" + userSendResp.getNombre() + "</td>"
                                                        + "<td class='mailbox-subject'><b>" + s.getNombreSolicitud() + "</b> " +cadena+ "..." + "</td>"
